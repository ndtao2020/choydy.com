  ...
  const sideNav = (
    ...
    >
      ...
      <Menu className='assistant-menu' orientation='vertical'>
        <NavLink className={({ isActive }) => "link" + (isActive ? " active" : "")} to='/vertical/settings' replace >
          <span className='link-icon icofont icofont-ui-settings' />
          <span className='link-text'>Settings</span>
        </NavLink>
        <NavLink className={({ isActive }) => "link" + (isActive ? " active" : "")} to='/vertical/default-dashboard' replace>
