          ...
          <ul class="navbar-nav ml-auto navbar-list">
              ...
              <div class="iq-sub-dropdown iq-sub-dropdown-large">
                <div class="iq-card shadow-none m-0">
                  <div class="iq-card-body p-0">
                    ...
                    <div v-for="(item, index) in userFriendRequest" :key="index" class="iq-friend-request">
            ...
            <li class="nav-item">
              <a href="#" class="search-toggle iq-waves-effect">
                <lottie-comp id="lottie-beil" :option="require('../../../assets/images/small/lottie-bell')" />
            ...
            <li class="nav-item dropdown">
              <a href="#" class="search-toggle iq-waves-effect">
                <lottie id="lottie-mail" :option="require('../../../assets/images/small/lottie-mail')" />
