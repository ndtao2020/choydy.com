      ...
      <iq-card>
        ...
        <template #body>
          ...
          <b-collapse id="collapse-1" class="mb-2">
            <div class="card">
              <kbd class="bg-dark">
                <pre id="table-1" class="text-white">
                    <code>
...
&lt;/script&gt;
      ...
      <iq-card>
        ...
        <template #body>
          <p>
            Similar to tables and dark tables, use the modifier classes <code class="highlighter-rouge">.thead-light</code> or
            <code class="highlighter-rouge">.thead-dark</code> to make <code class="highlighter-rouge">&lt;thead&gt;</code>s appear light or dark
            gray.
          </p>
          <b-collapse id="collapse-2" class="mb-2">
            <div class="card">
              <kbd class="bg-dark">
                <pre id="table-2" class="text-white">
                    <code>
      ...
      <iq-card>
        ...
        <template #body>
          ...
          <b-collapse id="collapse-3" class="mb-2">
            <div class="card">
              <kbd class="bg-dark">
                <pre id="table-3" class="text-white">
                    <code>
      ...
      <iq-card>
        ...
        <template #body>
          ...
          <b-collapse id="collapse-4" class="mb-2">
            <div class="card">
              <kbd class="bg-dark">
                <pre id="table-4" class="text-white">
                    <code>
...
&lt;/script&gt;
      ...
      <iq-card>
        ...
        <template #body>
          <p>
            A <code class="highlighter-rouge">&lt;caption&gt;</code> functions like a heading for a table. It helps users with screen readers to find
            a table and understand what it’s about and decide if they want to read it.
          </p>
          <b-collapse id="collapse-5" class="mb-2">
            <div class="card">
              <kbd class="bg-dark">
                <pre id="table-5" class="text-white">
                    <code>
&lt;b-table :items="items"&gt;
...
&lt;/script&gt;
          ...
          <b-table :items="items">
            <template #table-caption>List of users</template>
          </b-table>
        </template>
      </iq-card>
    </b-col>
      ...
      <iq-card>
        ...
        <template #body>
          ...
          <b-collapse id="collapse-6" class="mb-2">
            <div class="card">
              <kbd class="bg-dark">
                <pre id="table-6" class="text-white">
                    <code>
      ...
      <iq-card>
        ...
        <template #body>
          ...
          <b-collapse id="collapse-7" class="mb-2">
            <div class="card">
              <kbd class="bg-dark">
                <pre id="table-7" class="text-white">
                    <code>
      ...
      <iq-card>
        ...
        <template #body>
          ...
          <b-collapse id="collapse-8" class="mb-2">
            <div class="card">
              <kbd class="bg-dark">
                <pre id="table-8" class="text-white">
                    <code>
      ...
      <iq-card>
        ...
        <template #body>
          ...
          <b-collapse id="collapse-9" class="mb-2">
            <div class="card">
              <kbd class="bg-dark">
                <pre id="table-9" class="text-white">
                    <code>
&lt;b-table-simple&gt;
  &lt;b-thead&gt;
    &lt;b-th&gt;Variant&lt;/b-th&gt;
...
&lt;/b-table-simple&gt;
          ...
          <p>
            ...
            <a href="https://getbootstrap.com/" target="_blank">text or background utilities</a> to achieve similar styles.
          </p>
          <b-table-simple table-variant="dark">
            <b-thead>
              <b-th>#</b-th>
      ...
      <iq-card>
        ...
        <template #body>
          <p>
            ...
            <code class="highlighter-rouge">.table</code> with <code class="highlighter-rouge">.table-responsive</code>. Or, pick a maximum breakpoint
            with which to have a responsive table up to by using <code class="highlighter-rouge">.table-responsive{-sm|-md|-lg|-xl}</code>.
          </p>
          <b-collapse id="collapse-10" class="mb-2">
            <div class="card">
              <kbd class="bg-dark">
                <pre id="table-10" class="text-white">
                    <code>
