          ...
          <iq-card>
            ...
            <template #body>
              ...
              <b-form-group label="Facebook Url:" label-for="furl">
                <b-form-input id="furl" v-model="user.facebook_url" name="furl" placeholder="Facebook Url"></b-form-input>
              </b-form-group>
              <b-form-group label="Twitter Url:" label-for="turl">
                <b-form-input id="turl" v-model="user.twitter_url" name="turl" placeholder="Twitter Url"></b-form-input>
              </b-form-group>
              ...
              <div class="new-user-info">
                <b-row>
                  ...
                  <b-form-group class="col-md-6" label="Street Address 1:" label-for="add1">
                    <b-form-input id="add1" v-model="user.address1" type="text" name="add1" placeholder="Street Address 1"></b-form-input>
                  </b-form-group>
                  <b-form-group class="col-md-6" label="Street Address 2:" label-for="add2">
                    <b-form-input id="add2" v-model="user.address2" type="text" name="add2" placeholder="Street Address 2"></b-form-input>
                  </b-form-group>
                  <b-form-group class="col-md-6" label="Company Name:" label-for="cname">
                    <b-form-input id="cname" v-model="user.company_name" type="text" name="cname" placeholder="Company Name"></b-form-input>
                  </b-form-group>
                  ...
                  <b-form-group class="col-md-6" label="Town/City:" label-for="city">
                    <b-form-input id="city" v-model="user.city" type="text" name="city" placeholder="Town/City"></b-form-input>
                  </b-form-group>
                  <b-form-group class="col-md-6" label="Pin Code:" label-for="pno">
                    <b-form-input id="pno" v-model="user.pincode" type="text" name="pno" placeholder="Pin Code"></b-form-input>
                  </b-form-group>
                </b-row>
                <hr />
