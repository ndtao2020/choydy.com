          ...
          <div class="profile-header">
            ...
            <div class="profile-info p-4">
              <b-row>
                  ...
                  <div class="user-detail pl-5">
                    <div class="d-flex flex-wrap align-items-center">
                      <div class="profile-img pr-4">
                        <b-img :src="user.profile" alt="profile-img" fluid class="avatar-130" />
                      </div>
                ...
                <b-col md="6" sm="12">
                  <tab-nav id="pills-tab" :pills="true" class="profile-feed-items d-flex justify-content-end">
                    <tab-nav-items
                      id="pills-feed-tab"
                      :active="true"
                      href="#profile-feed"
      ...
      <b-row>
        <b-col lg="3" class="profile-left">
            ...
            <template #body>
              <ul class="profile-img-gallary d-flex flex-wrap p-0 m-0">
                <li v-for="(item, index) in galary" :key="index" class="col-md-4 col-6 pl-1 pr-0 pb-1">
                  <b-link :href="item.href"> <b-img :src="item.image" alt="gallary-image" fluid /></b-link>
                </li>
              </ul>
            </template>
          </iq-card>
          <iq-card>
            ...
            <template #body>
              <ul v-for="(feed, index) in twitterFeed" :key="index" class="pages-lists m-0 p-0">
          ...
          <iq-card>
            ...
            <template #body>
              <ul v-for="(feed, index) in recentPages" :key="index" class="pages-lists m-0 p-0">
                <li class="d-flex mb-4 align-items-center">
                  <div class="user-img img-fluid">
            ...
            <tab-content-item id="profile-feed" :active="true" aria-labelled-by="pills-feed-tab">
              <iq-card body-class="p-0">
                ...
                <div class="comment-area p-3">
                  ...
                  <hr />
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non, feugiat non nisi. Phasellus
            ...
            <template #body>
              <div class="about-info m-0 p-0">
                <b-row>
                  ...
                  <b-col cols="9"><b-link :href="user.email"> nikjone@demoo.com </b-link></b-col>
                  <b-col cols="3">Phone:</b-col>
                  <b-col cols="9"><b-link :href="user.phone">001 2351 256 12</b-link></b-col>
