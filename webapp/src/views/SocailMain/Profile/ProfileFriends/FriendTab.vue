<template>
  <div class="friend-list-tab mt-2">
    <tab-nav id="tab" :pills="true" class="nav nav-pills d-flex align-items-center justify-content-left friend-list-items p-0 mb-2">
      <tab-nav-items
    ...
    <div class="tab-content">
      <tab-content-item id="all-friends" :active="true" aria-labelled-by="pills-all-friends">
        <div class="iq-card-body p-0">
          <div class="row">
            <div v-for="(fried, index1) in frieds" :key="index1" class="col-md-6 col-lg-6 mb-3">
      ...
      <tab-content-item id="recently-add" :active="true" aria-labelled-by="pills-recently-add">
        <div class="iq-card-body p-0">
          <div class="row">
            <div v-for="(item, index) in recentlyAdded" :key="index" class="col-md-6 col-lg-6 mb-3">
              <div class="iq-friendlist-block">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    <a href="#">
      ...
      <tab-content-item id="closefriends" :active="true" aria-labelled-by="pills-closefriends">
        <div class="iq-card-body p-0">
          <div class="row">
            <div v-for="(closefriend, index) in closeFriend" :key="index" class="col-md-6 col-lg-6 mb-3">
              <div class="iq-friendlist-block">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    <a href="#">
      ...
      <tab-content-item id="home" :active="true" aria-labelled-by="pills-home">
        <div class="iq-card-body p-0">
          <div class="row">
            <div v-for="(home, index) in homeTown" :key="index" class="col-md-6 col-lg-6 mb-3">
              <div class="iq-friendlist-block">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    <a href="#">
