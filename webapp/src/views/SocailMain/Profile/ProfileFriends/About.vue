<template>
  <div class="row">
    <div class="col-md-3">
      <tab-nav id="tab" :pills="true" class="nav nav-pills basic-info-items list-inline d-block p-0 m-0">
        <tab-nav-items
          id="pills-contact-info"
          :active="true"
          href="#contact-info"
          aria-controls="pills-contact-info"
          role="tab"
          :aria-selected="true"
        ...
        <tab-nav-items
          ...
          :active="false"
          href="#family-info"
          aria-controls="pills-family-info"
          role="tab"
          :aria-selected="true"
        ...
        <tab-nav-items
          ...
          :active="false"
          href="#address-info"
          aria-controls="pills-address-info"
          role="tab"
          :aria-selected="true"
        ...
        <tab-nav-items
          ...
          :active="false"
          href="#about-info"
          aria-controls="pills-about-info"
          role="tab"
          :aria-selected="true"
    ...
    <div class="col-md-9">
      <div class="tab-content">
        <tab-content-item id="contact-info" :active="true" aria-labelled-by="pills-contact-info">
        ...
        <tab-content-item id="family-info" :active="false" aria-labelled-by="pills-family-info">
          ...
          <ul class="suggestions-lists m-0 p-0">
            ...
            <li v-for="(item, index) in friend" :key="index" class="d-flex mb-4 align-items-center">
        ...
        <tab-content-item id="work-info" :active="false" aria-labelled-by="pills-work-info">
        ...
        <tab-content-item id="address-info" :active="false" aria-labelled-by="pills-address-info">
        ...
        <tab-content-item id="about-info" :active="false" aria-labelled-by="pills-about-info">
