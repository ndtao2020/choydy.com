      ...
      <iq-card class="iq-card">
        <div class="iq-card-body p-0">
          <div class="user-tabing">
            <tab-nav id="pills-tab" :pills="true" class="nav nav-pills d-flex align-items-center justify-content-center profile-feed-items p-0 m-0">
              <tab-nav-items
                id="pills-feed-tab"
                class="col-sm-3 p-0"
                :active="true"
      ...
      <div class="tab-content">
            ...
            <b-row>
              <b-col lg="4">
                <iq-card>
                  <template #body>
                    <a href="#"
                      ><span class="badge badge-pill badge-primary font-weight-normal ml-auto mr-1"> <i class="ri-star-line"></i></span> 27 Items for
                      yoou</a
                    >
                  </template>
                </iq-card>
                <iq-card>
                  ...
                  <div class="row iq-card-body">
                    <div v-for="(event, index) in lifeEvent" :key="index" class="col-sm-12">
                      <div class="event-post position-relative">
                        <a href="#"> <img :src="event.img" alt="gallary-image" class="img-fluid rounded" /></a>
                ...
                <iq-card>
                  ...
                  <template #body>
                    <ul class="profile-img-gallary d-flex flex-wrap p-0 m-0">
                      <li v-for="(photo, index) in phtoes" :key="index" class="col-md-4 col-6 pl-2 pr-0 pb-3">
                ...
                <iq-card>
                  ...
                  <template #body>
                    <ul class="profile-img-gallary d-flex flex-wrap p-0 m-0">
                      <li v-for="(friend, index) in friends" :key="index" class="col-md-4 col-6 pl-2 pr-0 pb-3">
                        <a href="#"> <img :src="friend.img" alt="gallary-image" class="img-fluid" /></a>
        ...
        <tab-content-item id="profile-profile" :active="false" aria-labelled-by="pills-profile-tab">
          <iq-card>
            <template #body>
              <h2>Photos</h2>
              <tab-nav id="pills" :pills="true" class="nav nav-pills d-flex align-items-center justify-content-left friend-list-items p-0 mb-2">
                <tab-nav-items
              ...
              <div class="tab-content">
                <tab-content-item id="photo-you" :active="true" aria-labelled-by="pills-photo-you-tab">
                  <b-row>
                ...
                <tab-content-item id="your-photo" :active="false" aria-labelled-by="pills-your-photo-tab">
                  <ProfileImage />
                </tab-content-item>
              </div>
            </template>
