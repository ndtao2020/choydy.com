  ...
  <b-row>
      ...
      <b-card class="iq-card iq-card-block iq-card-stretch iq-card-height">
        ...
        <div class="iq-card-body">
          <ul class="music-lists m-0 p-0">
            <li v-for="(music, index) in musicData" :key="index" class="d-flex mb-4 align-items-center">
      ...
      <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
        ...
        <div class="iq-card-body">
          <Slick id="post-slider" class="d-flex list-inline m-0 p-0">
            <li v-for="(newmusic, index) in newMusic" :key="index" class="text-center col-md-12">
      ...
      <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
        ...
        <div class="iq-card-body">
          <Slick id="recent-music" class="d-flex list-inline m-0 p-0">
            <li v-for="(recent, index) in recentAdded" :key="index" class="text-center col-md-12">
              <div class="music-thumbnail position-relative mb-3">
    ...
    <b-col sm="12">
      <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
        ...
        <div class="iq-card-body">
          <Slick id="recent-music" class="d-flex list-inline m-0 p-0">
            <li v-for="(music, index) in topMusic" :key="index" class="text-center col-md-12">
              <div class="music-thumbnail position-relative mb-3">
