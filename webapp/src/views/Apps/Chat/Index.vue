            ...
            <b-row>
              <b-col lg="3" class="chat-data-left scroller">
                <div class="chat-search pt-3 pl-3">
                  ...
                  <div class="chat-searchbar mt-4">
                    <div class="form-group chat-search-data m-0">
                      <input id="chat-search" v-model="search" type="text" class="form-control round" placeholder="Search" />
                ...
                <div class="chat-sidebar-channel scroller mt-4 pl-3">
                  ...
                  <tab-nav id="chat-list-data" :pills="true" :vertical="true" class="iq-chat-ui">
                    <template v-for="(item, index) in privateList">
                      <tab-nav-items :id="`v-pills-${item.id}`" :key="index" href="#v-pills-home" :aria-controls="`v-pills-${item.id}`" role="tab">
                        <template #title>
                          <ChatItem :item="item" />
                        </template>
                      </tab-nav-items>
