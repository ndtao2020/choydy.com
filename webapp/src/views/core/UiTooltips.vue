    ...
    <b-row>
      ...
      <b-col lg="6" sm="12">
        <iq-card>
          ...
          <template #body>
            <p>
              Hover over the buttons below to see the four tooltips directions: top, right, bottom, and left. The data-placement attribute specifies
...
&lt;b-button href="#" v-b-tooltip.hover="'Some tooltip text!'" variant="link" &gt;Hover over me&lt;/b-button&gt;
            ...
            <b-button v-b-tooltip.hover="'Some tooltip text!'" href="#" variant="link">Hover over me</b-button>
          </template>
        </iq-card>
      </b-col>
    </b-row>
