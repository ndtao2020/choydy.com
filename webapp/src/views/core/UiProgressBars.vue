        ...
        <iq-card>
          ...
          <template #body>
            <p>
              ...
              <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/progress">the HTML5 <code>&lt;progress&gt;</code> element</a>,
            ...
            <b-collapse id="collapse-1" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="examples-1" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template #body>
            ...
            <b-collapse id="collapse-2" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="heights-1" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template #body>
            ...
            <b-collapse id="collapse-3" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="animated-stripe-1" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template #body>
            ...
            <b-collapse id="collapse-4" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="labels-1" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template #body>
            ...
            <b-collapse id="collapse-5" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="backgrounds-1" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template #body>
            ...
            <b-collapse id="collapse-6" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="multiple-bars-1" class="text-white">
                    <code>
&lt;b-progress max="100"&gt;
        ...
        <iq-card>
          ...
          <template #body>
            ...
            <b-collapse id="collapse-7" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="striped-1" class="text-white">
                    <code>
