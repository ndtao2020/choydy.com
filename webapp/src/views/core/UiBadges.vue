...
&lt;h6 class="mb-0"&gt;Example heading &lt;b-badge variant="info"&gt;New&lt;/b-badge&gt;&lt;/h6&gt;
          ...
          <h2 class="mb-3">Example heading <b-badge variant="secondary">New</b-badge></h2>
          <h3 class="mb-3">
            Example heading <b-button variant="success"> Notifications <b-badge variant="light" class="ml-2">4</b-badge> </b-button>
          </h3>
          <h4 class="mb-3">Example heading <b-badge variant="danger">New</b-badge></h4>
          <h5 class="mb-3">Example heading <b-badge variant="warning">New</b-badge></h5>
          <h6 class="mb-0">Example heading <b-badge variant="info">New</b-badge></h6>
...
&lt;/b-button&gt;
          ...
          <b-button variant="primary" class="mb-1 mr-1"> Notifications <b-badge variant="light" class="ml-2">4</b-badge> </b-button>
          <b-button variant="success" class="mb-1 mr-1"> Notifications<b-badge variant="light" class="ml-2">4</b-badge> </b-button>
          <b-button variant="danger" class="mb-1 mr-1"> Notifications<b-badge variant="light" class="ml-2">4</b-badge> </b-button>
        </template>
      </iq-card>
      <iq-card>
        <template #headerTitle>
...
&lt;/b-button&gt;
          ...
          <b-button variant="outline-primary" class="mb-1 mr-1"> Notifications <b-badge variant="primary" class="ml-2">4</b-badge> </b-button>
          <b-button variant="outline-success" class="mb-1 mr-1"> Notifications<b-badge variant="success" class="ml-2">4</b-badge> </b-button>
          <b-button variant="outline-danger" class="mb-1 mr-1"> Notifications<b-badge variant="danger" class="ml-2">4</b-badge> </b-button>
        </template>
      </iq-card>
      <iq-card>
        <template #headerTitle>
...
&lt;/b-button&gt;
          ...
          <b-button variant="none" class="iq-bg-primary mb-1 mr-1"> Notifications <b-badge variant="primary" class="ml-2">4</b-badge> </b-button>
          <b-button variant="none" class="iq-bg-success mb-1 mr-1"> Notifications<b-badge variant="success" class="ml-2">4</b-badge> </b-button>
          <b-button variant="none" class="iq-bg-danger mb-1 mr-1"> Notifications<b-badge variant="danger" class="ml-2">4</b-badge> </b-button>
        </template>
      </iq-card>
    </b-col>
    <b-col lg="6" sm="12">
...
&lt;b-badge href="#" variant="dark"&gt;Dark&lt;/b-badge&gt;
          ...
          <h5 class="card-title mt-4">Pill badges</h5>
          <p>
            Use the <code>.badge-pill</code> modifier class to make badges more rounded (with a larger <code>border-radius</code> and additional
            horizontal <code>padding</code>). Useful if you miss the badges from v3.
          </p>
          ...
          <h5 class="card-title mt-4">Links</h5>
          <p>
            Using the contextual <code>.badge-*</code> classes on an <code>&lt;a&gt;</code> element quickly provide <em>actionable</em> badges with
