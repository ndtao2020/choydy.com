...
&lt;/b-popover&gt;
            ...
            <b-button id="popover-button-variant" size="lg" variant="danger">Click to toggle popover</b-button>
            <b-popover target="popover-button-variant" variant="danger">
...
&lt;/b-popover&gt;
            ...
            <b-button id="popover-button-dismiss" href="#" variant="danger">Dismissible popover</b-button>
            <b-popover target="popover-button-dismiss" variant="danger" triggers="focus">
...
&lt;/span&gt;
        ...
        <iq-card>
          ...
          <template #body>
            <p>
              For disabled popover triggers, you may also prefer <code>data-trigger="hover"</code> so that the popover appears as immediate visual
              feedback to your users as they may not expect to <em>click</em> on a disabled element.
            </p>
...
&lt;/b-button&gt;
            ...
            <b-button v-b-popover.click.right="'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.'"> Popover on right </b-button>
            <b-button v-b-popover.click.bottom="'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.'"> Popover on bottom </b-button>
            <b-button v-b-popover.click.left="'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.'"> Popover on left </b-button>
          </template>
        </iq-card>
        <iq-card>
          <template #headerTitle>
...
&lt;/b-button&gt;
            ...
            <b-button v-b-popover.click.left="'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.'" variant="info"> Popover on left </b-button>
          </template>
        </iq-card>
        <iq-card>
          <template #headerTitle>
