<template>
  <div style="padding: 30px">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          Agreement) refers to ChoyDy, Quy Nhơn, Bình Định.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to ChoyDy.Com, accessible from
          <a href="https://choydy.com" rel="external nofollow noopener" target="_blank">https://choydy.com</a>
        </p>
      </li>
      <li>
        <p>
    ...
    <p>
      ...
      already associated with Your Third-Party Social Media Service's account, such as Your name, Your email address, Your activities or Your contact
      list associated with that account.
    </p>
    <p>
      You may also have the option of sharing additional information with the Company through Your Third-Party Social Media Service's account. If You
      choose to provide such information and Personal Data, during registration or otherwise, You are giving the Company permission to use, share, and
    ...
    <ul>
      ...
      <li>
        ...
        for Browser Cookies. For more information on how You can delete Flash Cookies, please read &quot;Where can I change the settings for
    ...
    <p>
      ...
      You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies:
    ...
    <ul>
      <li>
        <p>By email: choydy69@gmail.com</p>
      </li>
      <li>
        <p>By mail: Quy Nhơn, Bình Định</p>
      </li>
    </ul>
  </div>
</template>
