<template>
  <b-list-group class="listGroup thin-scroll">
    ...
    <b-list-group-item class="listGroupItem">
      ...
      <p class="deemphasize text-ellipsis m-0">Good news coming tonight. Seems they agreed to proceed</p>
    </b-list-group-item>
    <b-list-group-item class="listGroupItem">
      <span class="notificationIcon thumb-sm">
    ...
    <b-list-group-item class="listGroupItem">
      ...
      <p class="deemphasize text-ellipsis m-0">Just ain&apos;t sure about the weekend now. 90% I&apos;ll make it.</p>
    </b-list-group-item>
    <b-list-group-item class="listGroupItem">
      <span class="notificationIcon thumb-sm">
        <img class="rounded-circle" src="../../../assets/people/a6.jpg" alt="..." />
      ...
      <p class="deemphasize text-ellipsis m-0">Hey what&apos;s up? Me and Monica going for a lunch somewhere. Wanna join?</p>
    </b-list-group-item>
  </b-list-group>
</template>
