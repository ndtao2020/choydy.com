<template>
  <b-list-group class="listGroup thin-scroll">
    ...
    <b-list-group-item class="listGroupItem">
      ...
      <h6 class="m-0 mb-1">
        <span v-b-tooltip.hover class="circle bg-gray-dark text-warning" title="2 issues require your attention" placement="bottom">
    ...
    <b-list-group-item class="listGroupItem">
      ...
      <h6 class="m-0 mb-1 deemphasize text-gray">Complete project planning</h6>
